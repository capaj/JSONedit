            ...
            link: function(scope, element, attributes) {
                ...
                scope.deleteKey = function(obj, key) {
                    if (getType(obj) == "Object") {
                        ...
                        $log.error("object to delete from was " + obj);
                    }
                };
                scope.addItem = function(obj) {
                    if (getType(obj) == "Object") {
                        ...
                        $log.error("object to add to was " + obj);
                    }
                };
                ...
                // recursion
                var switchTemplate = '<span ng-switch on="getType(val)" >'
                ...
                var addItemTemplate = '<div ng-switch on="showAddKey" class="block" >'
                ...
                if (scope.type === "object") {
                    ...
                    $log.error("scope.type was " + scope.type);
                }
